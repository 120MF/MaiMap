// icon:bxs-x-circle | Boxicons https://boxicons.com/ | Atisa
import * as React from "react";

function IconBxsXCircle(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg fill="grey" height="1em" viewBox="0 0 24 24" width="1em" {...props}>
